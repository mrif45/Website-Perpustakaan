                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <?php if ($result->status == 1) { ?>
                                                                <a href="anggota.php?inid=<?php echo htmlentities($result->id_siswa); ?>" onclick="return confirm('Apakah anda yakin akan memblokir siswa ini?');"> <button class=" btn btn-danger"> Non-aktifkan</button>
                                                                <?php } else { ?>

                                                                    <a href="anggota.php?id=<?php echo htmlentities($result->id_siswa); ?>" onclick="return confirm('Apakah anda yakin akan mengaktifkan status siswa ini?');"><button class=" btn btn-primary">Aktifkan</button>
                                                                    <?php } ?>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
