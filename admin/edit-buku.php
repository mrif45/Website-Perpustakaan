                        ...
                        <div class=" panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                    <?php
                                    $idbuku = intval($_GET['id_buku']);
                                    $sql = "SELECT buku.nama_buku, kategori.nama_kategori, kategori.id_kategori as id_kat, buku.ISBN, buku.harga, buku.id_buku as idbuku from buku join kategori on kategori.id_kategori=buku.id_kategori where buku.id_buku=:idbuku";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':idbuku', $idbuku, PDO::PARAM_STR);
                                    $query->execute();
                                        ...
                                        foreach ($results as $result) {?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="kategori" required="required">
                                                    <option value="<?php echo htmlentities($result->id_kat); ?>"> <?php echo htmlentities($catname = $result->nama_kategori); ?></option>
                                                    <?php
                                                    $status = 1;
