...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        $query->execute();
        $_SESSION['delmsg'] = "Buku telah terhapus";
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Manajemen Buku</h4>
                    </div>
                    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php $sql = "SELECT buku.nama_buku, kategori.nama_kategori, buku.ISBN, buku.harga, buku.id_buku as id_buku from buku join kategori on kategori.id_kategori = buku.id_kategori";
                                            $query = $dbh->prepare($sql);
                                            $query->execute();
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) { ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><?php echo htmlentities($result->nama_kategori); ?></td>
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="edit-buku.php?id_buku=<?php echo htmlentities($result->id_buku); ?>"><button class="btn btn-primary"><i class='bx bxs-pencil nav__icon__lite'></i>Edit</button>

                                                                <a name="del" href="manajemen-buku.php?del=<?php echo htmlentities($result->id_buku); ?>" onclick="return confirm('Anda yakin ingin menghapus buku ini?');"> <button class=" btn btn-danger"><i class='bx bxs-trash-alt nav__icon__lite'></i> Hapus</button>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
