        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Manajemen Kategori Buku</h4>
                    </div>
                    <div class="row">
                                                ...
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="edit-kategori.php?id_kategori=<?php echo htmlentities($result->id_kategori); ?>"><button class="btn btn-primary"><i class='bx bxs-pencil nav__icon__lite'></i>Edit</button>

                                                                <a href="manajemen-kategori.php?del=<?php echo htmlentities($result->id_kategori); ?>" onclick="return confirm('Anda yakin ingin menghapus kategori ini?');"> <button class=" btn btn-danger"><i class='bx bxs-trash-alt nav__icon__lite'></i> Hapus</button>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
